...
public final class RoomInitializer {
    ...
    public static void initRooms(RoomList rooms) {
        ...
        // awolde1
        rooms.addRoom(objectAdventure.world.awolde1.MyRoom.newInstance());
