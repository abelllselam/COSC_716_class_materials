...
// $Id: Utils.java 1070 2025-02-10 23:54:58Z aconover $
...
public final class Utils {
     ...
     */
    public static String getFormattedItemList(Collection<? extends Item> itemCollection, DescriptionType descriptionType) {

        return itemCollection.stream().map(switch (descriptionType) {
    ...
    public static void displayImagePopup(String title, String imagePath) {
        ...
        try (InputStream imageStream = Utils.class.getResourceAsStream(imagePath)) {
            ...
            final Image scaledImage = getSizeBoundedImage(image, MAX_IMAGE_SIZE, MAX_IMAGE_SIZE);
    ...
    public static String boxifyText(String text, char corner, char horizontal, char vertical, int padding) {
        ...
        return "%s%n%s%s%n".formatted(top, middleBuilder.toString(), bottom);
    }
