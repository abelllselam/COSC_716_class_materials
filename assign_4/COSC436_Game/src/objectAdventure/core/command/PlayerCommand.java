...
// $Id: PlayerCommand.java 1070 2025-02-10 23:54:58Z aconover $
// AJC_TODO: Add handling of an auxiliaryClause.  E.g.: "handleLook under table", "drop item on item"
...
public record PlayerCommand(String originalInput, String verb, String noun) {
     ...
     * The input string must contain at least one word representing the verb and optionally followed by additional words representing the noun.
     *
