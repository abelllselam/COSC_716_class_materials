...
// $Id: SecretTestingItem.java 1028 2025-01-02 20:26:50Z aconover $
...
public class SecretTestingItem implements Item {
    ...
    private final MapTalker mapTalker;
     ...
     * ACTIVATE("Activate", "Enable"), DEACTIVATE("Deactivate", "Disable"): Activate or
     * deactivate an
     * Item.<br/>
     * OPEN("Open"), CLOSE("Close"): Open or close an Item.<br/>
     * THROW("Throw", "Toss"): Throw an Item.<br/>
     * REPAIR("Fix", "Repair", "Mend"), DESTROY("Break", "Destroy", "Smash"): Repair or destroy an
     * Item.<br/>
